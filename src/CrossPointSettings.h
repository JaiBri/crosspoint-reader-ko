...
class CrossPointSettings {
 ...
 public:
  ...
  // Font family options (upstream - kept for compatibility but Korean version uses custom fonts)
  enum FONT_FAMILY { BOOKERLY = 0, NOTOSANS = 1, OPENDYSLEXIC = 2, FONT_FAMILY_COUNT };
  // Font size options (upstream - kept for compatibility but Korean version uses custom fonts)
