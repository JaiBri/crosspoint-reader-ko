...
enum UIIcon { Folder, Text, Image, Book, File, Recent, Settings, Transfer, Library, Wifi, Hotspot, Game2048 };
...
class BaseTheme {
 public:
  ...
  virtual void drawStatusBar(GfxRenderer& renderer, const float bookProgress, const int currentPage,
                             ...
                             const int textYOffset = 0, const std::string& timeRemaining = "") const;
